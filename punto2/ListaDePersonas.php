...
<div class="container-fluid">
	...
	<main>
			...
			echo "<div class=\"row\">";
			echo "<div class=\"col-12 col-sm-2 p-5 text-center\"><h3><em>Nombre</em></h3></div>";
			echo "<div class=\"col-12 col-sm-2 p-5 text-center\"><h3><em>Apellido</em></h3></div>";
			echo "<div class=\"col-12 col-sm-1 p-5 text-center\"><h3><em>Edad</em></h3></div>";
			echo "<div class=\"col-12 col-sm-3 p-5 text-center\"><h3><em>Email</em></h3></div>";
			echo "<div class=\"col-12 col-sm-2 p-5 text-center\"><h3><em>Dni</em></h3></div>";
			echo "</div>";
			// Cuando coloco count (registro) es la cantidad de registros que tengo
				...
				?>	
					...
					<div class="col-12 col-sm-2 p-3 text-center border"> <?php echo$registro[$i]["nombre"]?> </div>
					<div class="col-12 col-sm-2 p-3 text-center border"> <?php echo$registro[$i]["apellido"]?> </div>
					<div class="col-12 col-sm-1 p-3 text-center border"> <?php echo$registro[$i]["edad"]?> </div>
					<div class="col-12 col-sm-3 p-3 text-center border"> <?php echo$registro[$i]["email"]?> </div>
					<div class="col-12 col-sm-2 p-3 text-center border"> <?php echo$registro[$i]["dni"]?> </div>
					</div> 
					<?php
					}             
					?>
